...
def task_e(data_training, data_validation):
    ...
    :return:
    """
    feature_arr = np.linspace(start=1, stop=9, num=9)
...
def task_f(data_training):
    ...
    rmse_mean, rmse_var = linear_least_squares.cross_validation(input_data, target_data, feature_arr)
